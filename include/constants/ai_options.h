...
#define OPTION_QUICK_ROUTE         1    // Maps to SaveBlock2->optionsQuickRoute
#define OPTION_IGNORE_BAG          2    // Maps to SaveBlock2->optionsIgnoreBag
#define OPTION_TEXT_SPEED          3    // Maps to SaveBlock2->optionsTextSpeed (3-bit field)

// Add new options ABOVE this line
#define AI_OPTION_COUNT            4
